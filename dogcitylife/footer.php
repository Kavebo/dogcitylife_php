	...
	<div class="container">
		...
		<div class="footer_menu">
			...
			<ul>
				...
				<li><a href="<?php echo get_front_url_lang() . "vyhledavani?typ[]=bar"; ?>"><?php _e('Bary'); ?></a></li>
		...
		<div class="footer_menu">
			...
			<ul>
				...
				<li><a href="<?php echo get_front_url_lang() . "vyhledavani?typ[]=bar&hodnoceni=5"; ?>"><?php _e('Bary'); ?></a></li>
